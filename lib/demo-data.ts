...
export const DEMO_JOBS: Job[] = [
  ...
  { id: 4, company: 'CloudNine', position: 'Backend Engineer', url: 'https://example.com/jobs/4', date_applied: '2025-03-03', status: 'interviewing', last_update: now, notes: 'Phone screen scheduled.', posting_status: 'active', created_at: now, updated_at: now },
